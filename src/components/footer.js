      ...
      <div className={`container`}>
        ...
        <div className={`row py-5`}>
          <div className={`col-xl-3  ${classes.contact}`}>
            ...
            <div>
              <p>Abbasaga / Besiktas</p>
              <p>Istanbul</p>
              <a className={'text-white'} href={'mailto:info@graycat.co'}>info@graycat.co</a>
            </div>
          </div>
          ...
          <div className={`col-xl-3 ps-5 md-my-4`}>
            <div className={classes.title}>
              <h3 className={`fs-4`}>Partners</h3>
            </div>
            <ul>
